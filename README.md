...
Install, create, and start the apache Gearbox container.

`./launch install apache`
...
### Available commands
If apache is symlinked to `launch`, then the Gearbox container will be determined automatically and the default command will be run.
